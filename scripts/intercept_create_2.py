...
def run():
    with sync_playwright() as p:
        ...
        try:
            ...
            print("Selecting book and subject...")
            # there are two "Please select..." dropdowns. We click them and pick the first option.
            for dropdown in page.get_by_text("Please select...", exact=True).all():
                dropdown.click()
                page.wait_for_timeout(500)
                # Click the first option that appears in the dropdown menu
                # The options usually have a specific role or class, let's just press Enter or click the first item in the listbox
            ...
            if len(inputs) >= 2:
                ...
                if btn.is_enabled():
                    ...
                    page.screenshot(path="create_cards_2.png")
