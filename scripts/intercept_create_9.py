...
def run():
    with sync_playwright() as p:
        ...
        try:
            ...
            # Try to dismiss any tutorials
            print("Dismissing tutorials...")
            page.keyboard.press("Escape")
            page.wait_for_timeout(500)
            page.keyboard.press("Escape")
            page.wait_for_timeout(500)
            # click on the header to dismiss popups
            page.mouse.click(10, 10)
            page.wait_for_timeout(1000)

            print("Typing into Quill editors...")
            editors = page.locator(".ql-editor").all()
            if len(editors) >= 2:
                # Normal click, should work if overlay is gone
                editors[0].click()
                ...
                page.screenshot(path="create_cards_9_before_save.png")
                ...
                if btn.is_enabled():
                    ...
                    page.screenshot(path="create_cards_9.png")
                else:
                    print("Button still disabled!")
                    page.screenshot(path="create_cards_9_disabled.png")
            else:
                print("Could not find Quill editors")

        except Exception as e:
            print(f"Error: {e}")
            page.screenshot(path="create_cards_9_error.png")
        finally:
            browser.close()
